...
btnStart.addEventListener('click', function() {
  ...
  for (let i = 1; i <= count; i = i + 1) {
    div01.innerHTML += '第' + i + '欢迎：' + name + '<br>';
  }

  //for的流程解释
  //假如用户输入的name是小邹，count是5
  ...
  //执行for里面的代码...
  //一直到i的值变成6，i<=count为false才能中断循坏
});

//通过数组循环显示数据
let names = ['构思', '逻辑', '判断', '思路'];
let div02 = document.getElementById('div02');
//数组拥有length长度，且能通过下标访问
//所以可以和for循环完美配合！！！
//由于数组下标是从0开始的，所以程序员养成了从0开始计数的习惯
